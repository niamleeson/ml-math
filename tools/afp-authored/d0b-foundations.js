/* =====================================================================
   AFP-AI Learning Guide — Domain 0 · ML Foundations  (modules M3–M5)
   ---------------------------------------------------------------------
   Authored source for the Curriculum track. One object per module.
   (M2, Feature engineering & leakage, is a multi-lesson SECTION in
   d0-m2-feature-engineering.js.)
