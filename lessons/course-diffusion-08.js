  ...
  window.LESSONS.push({
    ...
    sections: [
      ...
      },
      {
        ...
        <ol>
          ...
          <li><b>Total:</b> $0.1371 - 0.1197 + 0.1371 = 0.1546$ nats. <b>Why:</b> KL is the sum of its summands.</li>
        </ol>
      ...
      },
      {
        ...
        <p><b>Check 4 — matched variances, clean special case.</b> With $\\sigma_t^2 = \\tilde\\beta_t$, the constant in the Gaussian KL collapses to exactly zero and $L_{t-1}$'s inner KL is exactly $\\|\\tilde\\mu_t - \\mu_\\theta\\|^2 / 2\\tilde\\beta_t$ — part 5's equal-variance special case, no leftovers. A quick limit read: as $\\tilde\\beta_t \\to 0$ (late in training's low-noise steps), the same mean error costs more — precision matters most where the true denoiser is most certain.</p>
    ...
    practice: [
      ...
      },
      {
        ...
        answer: "All terms except $L_T$ depend on $\\theta$. $L_T$ is a schedule constant, so training minimizes $L_3 + L_2 + L_1 + L_0$ and simply ignores $L_T$."
      },
      {
