/* "Naked Statistics" (Charles Wheelan) — Conclusion: Five Questions Statistics Can Help Answer
...
(function () {
  ...
  window.CODEVIZ["naked-conclusion"] = {
    charts: [
      {
        "type": "bars",
      ...
      },
      {
        ...
        "series": [
          {
            "name": "1 in N (lower N = more common)",
            "color": "#4ea1ff",
            "points": [
              [
                2002,
