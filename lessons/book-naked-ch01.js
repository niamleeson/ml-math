    ...
    charts: [
      {
        ...
        labels: ["Cutler playoff", "Rodgers playoff", "Cutler earlier"],
        values: [31.8, 55.4, 85.6],
        colors: ["#ffb454", "#7ee787", "#4ea1ff"]
      }
    ]
  };

  // 2) Descriptive statistics simplify — strength and weakness
  B({
    id: "naked-ch1-descriptive-tradeoff",
    chapter: "Chapter 1",
    title: "Simplifying Is Strength and Weakness",
    tagline: "Collapsing data to one number is exactly what helps and what hurts.",
    sections: [
      {
        h: "The double-edged trade",
        body: "Wheelan says simplifying is \"both the strength and the weakness of any descriptive statistic.\" The single passer rating tells you Cutler was outgunned by Rodgers in the playoff loss. The same number stays silent on the texture of the game: whether a quarterback got a bad break (a perfect pass bobbled by a receiver and intercepted), whether he \"stepped up\" on a crucial third down rather than a meaningless end-of-game play (every completion is weighted the same), or whether the defense was simply terrible. He generalizes this with examples the reader already knows — a batting average that compresses a long career, and a grade point average."
      },
      {
        h: "The GPA example and its distortion",
        body: "A GPA assigns each letter a point value, then averages. It is easy to compute, easy to read, easy to compare across students — a nice descriptive statistic. But it ignores course difficulty, so a 3.4 in easy classes can outrank a 2.9 earned in calculus and physics.<table class=\"extable\"><thead><tr><th>letter grade</th><th class=\"num\">point value</th></tr></thead><tbody><tr><td class=\"row-h\">A</td><td class=\"num\">4</td></tr><tr><td class=\"row-h\">B</td><td class=\"num\">3</td></tr><tr><td class=\"row-h\">C</td><td class=\"num\">2</td></tr></tbody></table><ul class=\"steps\"><li>Wheelan's school tried to fix this by counting an A in an honors class as 5 instead of 4.</li><li>That backfired: for a heavy honors student, any A in a nonhonors course (gym, health) would pull the GPA below 5 and so drag it down.</li><li>Moral: leaning too hard on one descriptive statistic can mislead or push odd behavior — simplifying always sheds some nuance.</li></ul>"
      }
    ],
    takeaways: [
      "One number is handy precisely because it drops detail — that loss of detail is the cost.",
      "A passer rating hides bad breaks, clutch plays, and weak defenses.",
      "The honors-weighted GPA shows how a simplifying fix can create new distortions."
    ]
  });

  // 3) The Gini index for income inequality
  B({
    id: "naked-ch1-gini-index",
    chapter: "Chapter 1",
    title: "The Gini Index for Inequality",
    tagline: "One number from 0 to 1 captures how evenly a country shares its wealth.",
    sections: [
      {
        h: "Definition and scale",
        body: "The Gini index is economics' standard single-number tool for income (or wealth) inequality, and Wheelan's point is that it works \"just like the passer rating\" — it collapses complex information into one figure with no intrinsic meaning, useful only for comparison. It runs on a scale from zero to one.<ul class=\"steps\"><li>A country where every household holds identical wealth would score 0 (perfectly equal).</li><li>A country where one household held all the wealth would score 1 (perfectly unequal).</li><li>So the closer to 1, the more unequal the distribution.</li></ul>It can be computed for income or wealth, per individual or per household; those versions are highly correlated but not identical."
      },
      {
        h: "The United States figure",
        body: "Per the CIA, the United States has a Gini index of .45. (The index is sometimes multiplied by 100 to make it a whole number, which would put the U.S. at 45.) By itself .45 means little; it only becomes informative once placed beside other countries or other years — the subject of the next lesson."
      }
    ],
    takeaways: [
      "Gini runs 0 (everyone equal) to 1 (one household owns everything).",
      "It is a comparison tool, like the passer rating — no meaning on its own.",
      "The U.S. Gini index is .45 according to the CIA (or 45 on the times-100 scale)."
    ]
  });

  // 4) Comparison across place and time
  B({
    id: "naked-ch1-comparison",
    chapter: "Chapter 1",
    title: "Comparing Across Place and Time",
    tagline: "A lone statistic gains meaning only next to others — across countries or across years.",
    sections: [
      {
        h: "Across countries",
        body: "Once the U.S. .45 is set against other nations, it locates the country in the global spread of inequality.<table class=\"extable\"><thead><tr><th>country</th><th class=\"num\">Gini index</th></tr></thead><tbody><tr><td class=\"row-h\">Sweden</td><td class=\"num\">.23</td></tr><tr><td class=\"row-h\">Canada</td><td class=\"num\">.32</td></tr><tr><td class=\"row-h\">China</td><td class=\"num\">.42</td></tr><tr><td class=\"row-h\">United States</td><td class=\"num\">.45</td></tr><tr><td class=\"row-h\">Brazil</td><td class=\"num\">.54</td></tr><tr><td class=\"row-h\">South Africa</td><td class=\"num\">.65</td></tr></tbody></table>The U.S. sits in the more-unequal half of this list — well above Sweden and Canada, below Brazil and South Africa."
      },
      {
        h: "Across time",
        body: "The index also tracks change within one country.<ul class=\"steps\"><li>The U.S. Gini went from .41 in 1997 to .45 over the next decade (latest CIA data are 2007) — the country grew richer while wealth grew more unequal.</li><li>Canada's inequality was basically unchanged over roughly the same stretch.</li><li>Sweden's Gini fell from .25 in 1992 to .23 in 2005 — it grew richer and more equal.</li></ul>Wheelan's verdict: the Gini index is no more a perfect measure of inequality than the passer rating is of quarterbacking, but it delivers valuable information on a socially important phenomenon in a convenient format."
      }
    ],
    takeaways: [
      "U.S. .45 ranks between China (.42) and Brazil (.54); Sweden (.23) and Canada (.32) are more equal, South Africa (.65) more unequal.",
      "U.S. inequality rose from .41 (1997) to .45; Sweden fell from .25 (1992) to .23 (2005).",
      "A single statistic earns its meaning through comparison across place and time."
    ]
  });
  window.CODEVIZ["naked-ch1-comparison"] = {
    charts: [
      {
        type: "bars",
        ...
        labels: ["Sweden", "Canada", "China", "United States", "Brazil", "South Africa"],
        values: [0.23, 0.32, 0.42, 0.45, 0.54, 0.65],
        colors: ["#7ee787", "#7ee787", "#4ea1ff", "#ffb454", "#c89bff", "#c89bff"]
      },
      {
        type: "line",
