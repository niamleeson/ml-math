...
(function () {
  window.LESSONS.push({
    ...
    sections: [
      {
        h: "Where we are",
        body: `<p>Welcome. This course makes you one promise: by part 10 you will train, from scratch, the exact algorithm that powers the engine inside Stable Diffusion — and you will understand every line of it, because you will have derived every line yourself. Not "roughly how it works". The real thing: the algorithm from the 2020 paper <b>Denoising Diffusion Probabilistic Models</b> (DDPM), the same core that, scaled up and given a text encoder, became the image generators you have seen everywhere. When we are done you will be able to read <a onclick="App.open('paper-ddpm')">the DDPM paper lesson</a> the way its authors intended: as a sequence of moves you already know how to make.</p>
      ...
      },
      {
        ...
        <p><b>Read it out loud:</b> the distance between images $a$ and $b$ is: subtract the matching pixels, square each difference, add the squares, and take the square root. Small distance, similar images; large distance, different images. (The same formula with more terms works in any dimension — one squared difference per pixel.)</p>
    ...
    practice: [
      ...
      },
      {
        ...
        answer: "(a) $8^4 = 4096$ distinct images. (b) At most 100, which is about 2.4 percent of the possibilities — and for real images the ratio collapses to roughly $10^4$ out of $10^{1888}$, which is zero for every practical purpose. Memorization does not scale into generation."
      },
      {
