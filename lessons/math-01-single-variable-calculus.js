...
(function () {
  ...
  B(Object.assign({
    ...
    "practice": [
      {
        "problem": "$\\displaystyle\\lim_{x\\to2}\\frac{x^2-4}{x-2}$",
        "answer": "factor to $x+2$, limit $=4$"
      },
      {
        "problem": "$\\displaystyle\\lim_{x\\to0}\\frac{\\sin x}{x}$",
        "answer": "$1$ (at $x=0.01$, ratio $=0.99998$)"
      },
      {
        "problem": "$\\displaystyle\\lim_{x\\to3}\\frac{x^2-9}{x-3}$",
        "answer": "$6$"
      }
    ],
    "applications": [
